<template>
  <div class="vh-100 book-wallpaper">
    <div class="uk-flex uk-flex-center uk-flex-wrap">
      ...
      <div
        class="uk-card uk-card-default uk-width-3-4 uk-width-2-3@s uk-width-1-3@m uk-margin"
      >
        ...
        <div class="uk-card-body">
          <ValidationObserver v-slot="{ invalid }">
            ...
            <v-input className="uk-margin-small-bottom" inputClass="uk-form-small uk-input " v-model="model.firstName"  placeholder="Nombre"/>
            <v-input className="uk-margin-small-bottom" inputClass=" uk-form-small uk-input" v-model="model.lastName"  placeholder="Apellido"/>
            <v-input className="uk-margin-small-bottom" 
